...
# === CONFIG ===
DELAY_TIME = 3           # Delay before green after detection (in steps)
COOL_OFF_PERIOD = 10    # Cooldown period in steps
EXIT_DELAY = 30         # Time after last bus to stop simulation (in steps)
